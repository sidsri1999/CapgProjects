	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(check.equals("fine")) {
			...
			if(city.equals("Greater Noida")) {
				...
				RequestDispatcher rd=request.getRequestDispatcher("GreaterNoida");  
		        rd.forward(request, response);
			}else if(city.equals("Noida")) {
				RequestDispatcher rd=request.getRequestDispatcher("Noida");  
		        rd.forward(request, response);
			}else if(city.equals("Gurgaon")) {
				RequestDispatcher rd=request.getRequestDispatcher("Gurgaon");  
		        rd.forward(request, response);
			}else if(city.equals("Delhi")) {
				RequestDispatcher rd=request.getRequestDispatcher("Delhi");  
		        rd.forward(request, response);
			}
		}else {
